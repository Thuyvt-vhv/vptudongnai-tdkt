...
const ALL_NOTIFS_BY_ROLE: Record<string, Notif[]> = {
  "lãnh đạo cấp cao": [
    ...
    { id:"l5", type:"ai", priority:"normal", title:"AI: 3 hồ sơ ưu tiên đề nghị HuânC LĐ hạng Ba", body:"Trợ lý AI đã phân tích và gợi ý 3 cá nhân đủ điều kiện đề nghị Huân chương Lao động hạng Ba trong kỳ xét năm 2026.", time:"5 giờ trước", timestamp:5*60*60*1000, read:true, action:{ label:"Xem gợi ý AI", target:"Trợ lý AI" } },
  ...
  "quản trị hệ thống": [
    ...
    { id:"a5", type:"ai", priority:"normal", title:"Trợ lý AI: 127 phiên hỏi đáp hôm nay", body:"Trợ lý AI xử lý 127 câu hỏi, độ chính xác trung bình 94.2%. Top 3 chủ đề: điều kiện khen thưởng, mẫu biểu, SLA.", time:"8 giờ trước", timestamp:8*60*60*1000, read:true },
