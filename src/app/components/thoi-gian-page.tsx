...
const ACTIVITY_BY_ROLE: Record<string, ActivityEntry[]> = {
  "lãnh đạo cấp cao": [
    ...
    { id:"a7", time:"10:15", timestamp: Date.now() - 1*60*60*1000, type:"ai", title:"Hỏi Trợ lý AI Tố Nga", detail:"Câu hỏi: \"Điều kiện đề nghị Huân chương LĐ hạng Nhì là gì?\"", module:"Trợ lý AI Tố Nga", duration:"3 phút" },
  ...
  "hội đồng": [
    ...
    { id:"c5", time:"09:15", timestamp: Date.now() - 2.7*60*60*1000, type:"ai", title:"AI phát hiện trùng lặp", detail:"AI báo: NS-2026-0152 trùng 89% NS-2025-0234. Đánh dấu cần xem xét.", module:"Trợ lý AI Tố Nga", duration:"5 phút" },
